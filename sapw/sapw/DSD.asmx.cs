...
namespace sapw
{
   ...
   /*     [WebMethod]
     ...
     /*   [WebMethod(Description = "Chama o cliente pela BAPI")]
        ...
        [WebMethod(Description = "Visualiza processamento de cargas do SFCoke(dd/mm/yy")]
        public DataSet Processamento_SFCoke(string Data)
        {
            Sfcoke ObjSfcoke = new Sfcoke();
            return ObjSfcoke.descargas_sfcoke(Data);
        }

        [WebMethod(Description = "Pega horário do pedio SAP")]
        public DataTable VERIFICA_HORA_PEDIDO(string N_Pedido)
        {
         ...
         [WebMethod(Description = "Pegar log de processamento do Pedido SFCoke x SAP")]
        public DataTable VERIFICA_LOG_PROC_PEDIDOS_SFCSAP(string N_Pedido)
        {
         ...
         [WebMethod(Description = "Mostrar se o nível de Isolamento do SQLServer está padrão para o SFCoke, que deve ser SnapShot")]
         public DataSet VERIFICA_NIVEL_ISOLAMENTO_SQLSERVER()
         {
             Sfcoke ObjSfcoke = new Sfcoke();
             return ObjSfcoke.verificaNivelIsolamentoSQLServer();
         }

         [WebMethod(Description = "Mostrar se o nível de Isolamento do SQLServer está padrão para o SFCoke, que deve ser SnapShot")]
         public DataSet VERIFICA_PROCESSOS_SQLSERVER()
         {
             Sfcoke ObjSfcoke = new Sfcoke();
             return ObjSfcoke.verificaProcessosAtivosSQLSever();
         }

         [WebMethod(Description = "Mostra o tempo do último pedido processado no SAP")]
         public DataSet VERIFICA_ULTIMO_PEDIDO_PROCESSADO_SAP()
         {
             Sfcoke ObjSfcoke = new Sfcoke();
             return ObjSfcoke.verificaUltimoPedidoProcessadoSAP();
         }

         [WebMethod(Description = "Mostra o tempo do último pedido Recebido")]
         public DataSet VERIFICA_ULTIMO_PEDIDO_RECEBIDO()
         {
             Sfcoke ObjSfcoke = new Sfcoke();
             return ObjSfcoke.verificaUltimoPedidoRecebido();
         }


         [WebMethod(Description = "Lista as Entregas do Cliente")]
         ...
         [WebMethod(Description = "Mostra oS vendedores que ainda não descarregaram")]
         public DataSet VERIFICA_VENDEDORES_SEM_DESCARGA()
         {
             Sfcoke ObjSfcoke = new Sfcoke();
             return ObjSfcoke.verificaVendedoresSemDescarga();
         }

        [WebMethod(Description = "Pedidos")]
        ...
        [WebMethod(Description = "Itens do Pedido")]
        ...
        [WebMethod(Description = "Status de Documentos de Transporte")]
        ...
        [WebMethod(Description = "Ver saldo de Estoque")]
